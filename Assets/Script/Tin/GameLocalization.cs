...
public static class GameLocalization
{
    ...
    private static readonly Dictionary<string, string[]> Text = new Dictionary<string, string[]>
    {
        ...
        { "backpack.quest.level5.tier", new[] { "MILITARY ZONE MILESTONE  //  BACKPACK L5", "MỐC KHU QUÂN SỰ  //  BALO CẤP 5" } },
        { "backpack.quest.level5.title", new[] { "BACKPACK LEVEL 5 ACQUIRED", "ĐÃ NHẬN BALO CẤP 5" } },
        { "backpack.quest.level5.body", new[] { "Military-zone milestone: maximum field capacity unlocked.", "Mốc khu quân sự: đã mở khóa sức chứa kho tối đa." } },
