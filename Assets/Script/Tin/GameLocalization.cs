...
public static class GameLocalization
{
    ...
    private static readonly Dictionary<string, string[]> Text = new Dictionary<string, string[]>
    {
        ...
        { "backpack.quest.level4.tier", new[] { "HOSPITAL MILESTONE  //  BACKPACK L4", "MỐC BỆNH VIỆN  //  BALO CẤP 4" } },
        { "backpack.quest.level4.title", new[] { "BACKPACK LEVEL 4 ACQUIRED", "ĐÃ NHẬN BALO CẤP 4" } },
        { "backpack.quest.level4.body", new[] { "Hospital milestone: field capacity expanded.", "Mốc bệnh viện: sức chứa kho đã được mở rộng." } },
        { "backpack.quest.level5.tier", new[] { "RADIO RESTORATION MILESTONE  //  BACKPACK L5", "MỐC PHỤC HỒI RADIO  //  BALO CẤP 5" } },
        { "backpack.quest.level5.title", new[] { "BACKPACK LEVEL 5 ACQUIRED", "ĐÃ NHẬN BALO CẤP 5" } },
        { "backpack.quest.level5.body", new[] { "Radio milestone: maximum field capacity unlocked.", "Mốc phục hồi Radio: đã mở khóa sức chứa kho tối đa." } },
