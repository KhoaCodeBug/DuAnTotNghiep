...
public class CharacterSelectionMenu : MonoBehaviour
{
    ...
    private string[] characterStats = {
        "<color=#ff5555>KỸ NĂNG: CƠN ĐIÊN LÂM CHUNG</color>\nBản năng sinh tồn tột độ. Khi hạ sát 10 thực thể đột biến, lượng adrenaline kích phát vượt giới hạn cơ thể. Xóa bỏ hoàn toàn độ giật và tiêu hao đạn dược trong 5 giây kinh hoàng.\n<color=#aaaaaa>[Thời gian hồi phục: 50s]</color>",
        "<color=#55ffff>KỸ NĂNG: BÓNG ĐÊM TĨNH LẶNG</color>\nSinh ra để lẩn khuất. Khi hạ thấp trọng tâm [Nhấn C], nhịp tim và hơi thở đồng bộ với môi trường xung quanh. Đánh lừa hoàn toàn giác quan của lũ thây ma trong 5 giây.\n<color=#aaaaaa>[Thời gian hồi phục: 30s]</color>"
    };
