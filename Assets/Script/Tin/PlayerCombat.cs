...
public class PlayerCombat : NetworkBehaviour
{
    ...
    private void Bash()
    {
        // A real, accepted melee attack interrupts corpse searching on the
        // attacking player's client. The corpse remains unsearched and can be
        // searched again from the beginning afterwards.
        if (HasInputAuthority)
            AutoUIManager.Instance?.CancelTimedGameplayAction();
